...
public:
  ...
  void processDatasetRepeatTest(SpatiallySparseDataset &dataset, int batchSize, int nReps,float *scores, std::string predictionsFilename="",std::string header="",std::string confusionMatrixFilename="");
